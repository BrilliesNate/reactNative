...
const FinancialBackground = require("../assets/imgs/FinancialBenefits.png")
const IntroScreen = require("../assets/imgs/IntroScreen.png")
const relay = require("../assets/imgs/relay.png")
const battery = require("../assets/imgs/battery.png")

const greenDot = require("../assets/imgs/greenDot.png")
const DashboardSVG = require("../assets/imgs/myPower24PhoneDashboard.png")
const Onboarding = require("../assets/imgs/bg.png");
const Logo = require("../assets/imgs/myPower24Logo.png");
